...
When the file split name is 'new+penn+bed+07091127', run _python render_shading.py --house='penn' --floor='bed' --pano='07091127' --height=512_
...
Go to folder [03_3DFloor_Mesh](https://github.com/bh2619-k/virtual-home-staging/tree/main/03_3DFloor_Mesh) and run floormesh.py --split='new+penn+bed+07091127'
